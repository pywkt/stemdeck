...
class Job:
    ...
    # Which separator backend produced the stems ("htdemucs_6s" /
    # "bs_roformer_sw"), recorded per job -- the model setting may change
    # between jobs, so this pins what this job actually ran.
